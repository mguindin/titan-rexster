...
sed -i "s/_HBASE_HOSTNAME_/${HBASE_PORT_2181_TCP_ADDR}/g" $OUT
...
wait_for_startup HBase \
	$HBASE_PORT_2181_TCP_ADDR \
  $HBASE_PORT_2181_TCP_PORT \
	$HBASE_STARTUP_TIMEOUT_S || {
	return 1
}
